...
class ReservationController extends Controller
{
    ...
    public function results(Request $request)
    {
        ...
        return Inertia::render('reservations/results', [
            'viajes' => $viajes
        ]);
    }
    ...
    {
        return Inertia::render('reservations/seats');
    }

    public function checkout()
    {
        return Inertia::render('reservations/checkout');
    }
    ...
    public function completarPago(Request $request)
    {
        try {
            ...
            return to_route('reservations.confirmation', [
                'id' => $identifier
            ]);
        } catch (\Throwable $th) {
            throw $th;
